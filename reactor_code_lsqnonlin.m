...
options = optimoptions('fsolve','Display','iter','TolFun',10^-23,'TolX',10^-20,'MaxIter',1000,'MaxFunEvals',10^10)
[x,should_be_zero] = lsqnonlin(@(x)design_system3(x,P,y0,KH_O2,dens_me,dens_w,dens_dmc,k_1,k_2,n_DMC,V,MR),x0,zeros(size(x0)),10^8*ones(size(x0)),options)
